...
<div class="container mt-5">
    <div class="row justify-content-center">
            ...
            <div class="card pt-3 pb-3">
                <div class="card-body">
                    ...
                    <form method="post" action="include/login.inc.php">
                        ...
                        <br>
                        <button type="submit" name="submit" class="btn btn-custom btn-block">Log In</button>
                    </form>
                    <br>
        ...
        <div class="col-md-7">
            <h1 class="display-3" id="login-banner">Unlock Financial Freedom with ANJAY BudTrack!</h1>
        </div>
    </div>
</div>
...
<!-- Custom JavaScript -->
<script>
    typing_text("Unlock Financial Freedom with ANJAY BudTrack!", "login-banner");
</script>
